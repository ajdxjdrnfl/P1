...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 14, -1, -1, sizeof(::Protocol::SkillInfo)},
};
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\002\022(\n\ncastertype\030\010 \001(\0162\024.Protocol.Cast"
  "erType\"\035\n\tSkillInfo\022\020\n\010skill_id\030\001 \001(\004b\006p"
  "roto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 245, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
...
uint8_t* ObjectInfo::_InternalSerialize(
  ...
  if (this->_internal_castertype() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      8, this->_internal_castertype(), target);
  }
